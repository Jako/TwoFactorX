...
<p>Sie erhalten diese E-Mail, weil die Zwei-Faktor-Authentifizierung für Ihr Konto aktiviert wurde. Um die Zwei-Faktor-Authentifizierung zu nutzen, benötigen Sie ein unterstütztes Gerät oder eine Anwendung, die ein zeitbasiertes Einmalpasswort generiert, z.B. Google Authenticator, Authy oder 1Password. Ohne einen Authentifizierungsschlüssel können Sie sich nur einmal anmelden. Wenn Sie sich erfolgreich angemeldet haben, erhalten Sie nur Ihren QR-Code und werden sofort abgemeldet.</p>
<p>Öffnen Sie die Authentifizierungsanwendung und scannen Sie den mitgelieferten QR-Code. Sobald dieser Vorgang erfolgreich abgeschlossen ist, wird alle 30 Sekunden ein neuer Authentifizierungsschlüssel angezeigt.</p>
...
<p>Um die Zwei-Faktor-Authentifizierung zu nutzen, benötigen Sie ein unterstütztes Gerät oder eine Anwendung, die ein zeitbasiertes Einmal-Passwort zu generieren, z. B. Google Authenticator, Authy oder 1Password. Öffnen Sie die Authentifizierungsanwendung und scannen den bereitgestellten QR-Code. Sobald dieser Vorgang erfolgreich abgeschlossen ist, wird alle 30 Sekunden ein neuer Authentifizierungsschlüssel angezeigt. Dieser Schlüssel wird nun beim Einloggen benötigt.</p>
<p>[[+qrsvg]]</p>
<p>Secret: [[+secret]]</p>';
